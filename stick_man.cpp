...
void stickman_close(int speed,int color)
{
	...
	for(int i=0;i<3;i++)
	{
		setcolor(color);
		circle(50+s,320,30+i);
		line(50+i+s,300,50+i+s,400);
		//legs
		
		line(50-i+s,400,50-s+i,450);
		line(50+i+s,400,50-s+i,450);
		//left hand
			line(50+s+i,360,20+s+i,400);
			//right hand
...
void stickman_chat(int speed, int box_color,int text_color)
{
		...
		int points[16] = {50+s,280,40+s,270,-40+s,200,70+s,200,70+s,270,60+s,270,50+s,280};
		drawpoly(8,points);
		
		setcolor(text_color);
		
		settextstyle(EUROPEAN_FONT,HORIZ_DIR,1);
			outtextxy(-20+s,210char "I Love");
...
void stickwoman_chat(int speed, int box_color,int text_color)
{
		...
		int points[16] = {50+s,280,40+s,270,30+s,270,30+s,200,140+s+50,270,60+s,270,50+s,280};
		drawpoly(8,points);
